...
LIGHTNING_TB_PATH = 'lightning_logs/version_0/tf/'
...
def init_exp_folder(args):
    ...
    exp_ckpt_path = join(exp_path, "ckpts")
    ...
    # ln -s for checkpoints
    os.symlink(join(exp_path, LIGHTNING_CKPT_PATH), exp_ckpt_path)
